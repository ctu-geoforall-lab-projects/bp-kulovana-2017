...
Povinným výstupem zásuvného modulu je textový report s příponou \textit{.txt}, který obsahuje souřadnice lomových bodů zjednodušených polygonů v hlásném systému \zk{MGRS}. Výstupní report je součástí \zk{MTF} zprávy, proto musí splňovat přesně daný formát specifikovaný v katalogu APP-11. Jeden řádek reportu obsahuje:
...
\begin{figure}[H]
    \centering
%      \includegraphics[width=350pt]{./pictures/}
...
\begin{figure}[H]
    \centering
      \includegraphics[width=350pt]{./pictures/ACR_radiacni_pruzkum_polygony_v2.png}
...
%							\STATE{uzavíranáLinie je uzavřena -> konec výpočtu}
%							\BREAK
%						\ELSE
%							\STATE{pokračuj na řádce ...}
%						\ENDIF
