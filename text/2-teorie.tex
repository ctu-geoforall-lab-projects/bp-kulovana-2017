...
\item \textbf{Přímo ionizující záření} mohou způsobovat jen nabité
  částice, které mají dostatečnou kinetickou energii k vyvolání
...
stálé složky \zk{RMS} patří v první řadě \zk{SÚJB}, Státní ústav
radiační ochrany (\zk{SÚRO}) a Český hydrometeorologický úřad
(\zk{ČHMÚ}). Při přechodu do havarijního režimu dochází rovněž k
...
nepokračuje ve směru rostoucích hodnot do epicentra
...
popisuje nadporučík Jiří Komárek, starší důstojník Skupiny
...
záchranný sbor ČR, Generální ředitelství cel, Armáda ČR, Policie ČR a
ČEZ, a.s.
...
systému \zk{MGRS}, který bude součástí \zk{MTF} zprávy. (viz Kapitola
4.4 Výstupní report)

\subsection{Military grid reference system}
Hlásný systém MGRS (\zk{MGRS}) je systém udávání polohy používaný
