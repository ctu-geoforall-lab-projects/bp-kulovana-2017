...
pod záštitou neziskové the Python Software Foundation (\zk{PSF}). Je
distribuován pod licencí (\zk{PSF}), která je s (\zk{GPL})
...
% zmínit Qt Designer % (5) https://www.qt.io/company/
