...
\stranka{%nahore
	...
	\vspace{1em}
		%\noindent
	\par\hspace{2ex}
	{V~první řadě děkuji vedoucímu bakalářské práce, Ing. Martinu Landovi, PhD., za~rady a pomoc při~zpracování této práce. Dále děkuji Mgr. Janu Helebrantovi (SÚRO) a nadporučíkovi Jiřímu Komárkovi (AČR) za~cenné připomínky a odborné informace. V~neposlední řadě děkuji svým blízkým za~projevenou podporu.}
}
